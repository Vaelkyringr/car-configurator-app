...
export const data: CarOptions[] = [
    ...
    { id: crypto.randomUUID(), category: 'Engine', title: "T6 Plug-in Hybrid", filename: 'path',  cost: 55000 },
    { id: crypto.randomUUID(), category: 'Engine', title: 'D5 Mild Hybrid', filename: 'path', cost: 40000 },
    { id: crypto.randomUUID(), category: 'Engine', title: 'D4 Mild Hybrid', filename: 'path', cost: 25000 },
